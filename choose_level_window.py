...
class Choose:
    def __init__(self, surface):
        ...
        # кнопки перехода к 1 и 2 уровню
    ...
    def button(self):
        # нажатие и определение, какая именно кнопка была нажата
        return self.result
    ...
    def run(self):
        ...
        # текст вывода рекордов
        level_1_score_text = self.font.render(
            f'YOUR BEST: {score(get_best_result("data/levels_score/level_1_score.txt"))}', False,
            'white')
        level_2_score_text = self.font.render(
            f'YOUR BEST: {score(get_best_result("data/levels_score/level_2_score.txt"))}', False,
            'white')
        ...
        # определение, какая именно кнопка нажата
